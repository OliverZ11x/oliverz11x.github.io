...
1. Win+R 打开 winver
	![Pasted image 20240722100904.png](../01attachment/Pasted%20image%2020240722100904.png)
2. 查看版本号，内部版本需大于 19041
	![1721614265879.jpg](../01attachment/1721614265879.jpg)
3. 如果是早先的版本建议更新下

### WSL 2 的安装

1. 打开控制面板->程序->启用或关闭 Windows 功能>适用于 Linux 的 Windows 子系统和虚拟机平台
	![Pasted image 20240722101342.png](../01attachment/Pasted%20image%2020240722101342.png)
2. 重启系统
...
1. 输入 `nvidia-smi`，显示当前驱动版本。
	![Pasted image 20240722141439.png](../01attachment/Pasted%20image%2020240722141439.png)
2. 根据[驱动版本、python 版本和 tensorflow 版本](https://tensorflow.google.cn/install/source?hl=en#gpu)安装 [cuda 11.2](https://developer.nvidia.com/cuda-11.2.0-download-archive?target_os=Linux&target_arch=x86_64&target_distro=WSLUbuntu&target_version=20&target_type=debnetwork)，cuda 版本号需要低于驱动版本号，如果驱动版本过低，请[升级 CUDA 驱动](./CUDA%20%E7%8E%AF%E5%A2%83%E9%85%8D%E7%BD%AE.md#升级%20CUDA%20驱动)。安装错误，请[卸载驱动](./CUDA%20%E7%8E%AF%E5%A2%83%E9%85%8D%E7%BD%AE.md#Wsl%20Ubuntu%2022.04%20cuda%2012.5%20卸载)重新安装。
3. 检查是否安装好 `nvcc -V` 输出结果：
	![Pasted image 20240722145921.png](../01attachment/Pasted%20image%2020240722145921.png)
...
![Pasted image 20240723103447.png](../01attachment/Pasted%20image%2020240723103447.png)

### Anaconda 安装

1. 进入 [网址](https://repo.anaconda.com/archive/)手动下载 anaconda 安装包到 `D:\Ubuntu\anaconda` 中
	![1721615383817 2.png](../01attachment/1721615383817%202.png)
